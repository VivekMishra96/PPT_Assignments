# -*- coding: utf-8 -*-
"""train-yolov8-classification-on-custom-dataset.ipynb
...
!unzip /content/drive/MyDrive/veg.zip
...
!yolo task=classify mode=train model=yolov8s-cls.pt data=/content/drive/MyDrive/Vegetable_Images epochs=100 imgsz=200
...
# Commented out IPython magic to ensure Python compatibility.
# %cd {HOME}
!yolo task=classify mode=predict model={HOME}/runs/classify/train/weights/best.pt conf=0.25 source=/content/drive/MyDrive/veg
